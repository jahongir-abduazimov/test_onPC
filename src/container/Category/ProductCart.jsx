  ...
  return (
    <div className="relative bg-white shadow-md border-t-2 rounded-lg group overflow-hidden hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="hidden group-hover:flex justify-between items-center transition-all duration-300 mx-4">
        <button className="flex gap-2 md:gap-4 items-center border-2 border-[#FF6A6A] text-[#FF6A6A] text-[10px] md:text-[14px] px-2 py-2 rounded-[8px] cursor-pointer">
          <BsCartDash /> <span>Add to cart</span>
        </button>
        <LiaBalanceScaleLeftSolid color="red" size={24} />
      </div>
    </div>
  );
};
